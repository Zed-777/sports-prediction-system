...
class RealTimeDataIntegrator:
    ...
    def __init__(self) -> None:
        self.football_api_key = os.getenv(
            "FOOTBALL_DATA_API_KEY", "17405508d1774f46a368390ff07f8a31",
        )
    ...
    def get_player_availability_impact(self, team_name: str) -> tuple[float, list[str]]:
        ...
        availability_multiplier = (
            total_impact / max_possible if max_possible > 0 else 1.0
        )
    ...
    def integrate_realtime_data(self, match_data: dict[str, Any]) -> dict[str, Any]:
        ...
        home_availability, home_availability_notes = (
            self.get_player_availability_impact(home_team)
        )
        away_availability, away_availability_notes = (
            self.get_player_availability_impact(away_team)
        )
    ...
    def _calculate_form_adjusted_probabilities(
        self,
        home_form: TeamForm,
        away_form: TeamForm,
        home_avail: float,
