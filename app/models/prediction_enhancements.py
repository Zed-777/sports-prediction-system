...
class RefereeTendencyDatabase:
    ...
    def update_referee_stats(
        ...
        tendency.avg_yellow_cards = (tendency.avg_yellow_cards * n + yellow_cards) / (
            n + 1
        )
        ...
        tendency.home_win_rate = (
            tendency.home_win_rate * n + (1 if home_win else 0)
        ) / (n + 1)
...
class LeagueCalibrator:
    ...
    def get_calibration(self, league: str) -> dict[str, float]:
        ...
        return {
            ...
            "upset_likelihood_base": 1
            - predictability,  # Less predictable = more upsets
            "draw_rate_adjustment": 0.0,  # Can be league-specific
        }

    def adjust_confidence(self, confidence: float, league: str) -> float:
...
class KickoffTimeAnalyzer:
    ...
    def get_adjustments(self, kickoff_time: datetime) -> dict[str, float]:
        ...
        return {
            ...
            "time_slot": time_slot,
            "day_of_week": day,
            "is_tv_slot": day in ["monday", "friday"]
            or time_slot in ["evening", "night"],
        }
