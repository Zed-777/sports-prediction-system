...
def load_throttle_config() -> dict:
    ...
    throttle_bucket_by_host = (cfg.get('data_sources') or {}).get('throttle_bucket_by_host', {})
    throttle_bucket_by_endpoint = (cfg.get('data_sources') or {}).get('throttle_bucket_by_endpoint', {})
    return {
