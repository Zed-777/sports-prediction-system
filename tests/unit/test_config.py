...
class TestSubstituteEnvVars:
    ...
    def test_substitute_nested_dict(self):
        ...
        with patch.dict('os.environ', {'DB_URL': 'postgres://...', 'API_KEY': 'key123'}):
...
class TestValidateConfig:
    ...
    def test_validate_missing_football_data(self):
        ...
        with pytest.raises(ValueError, match="Football data source configuration is required"):
            validate_config(config)
...
class TestCreateDefaultConfig:
    ...
    def test_create_default_config_structure(self):
        ...
        required_keys = [
            'environment', 'random_seed', 'timezone_storage',
            'database', 'data_sources', 'models', 'logging'
        ]
