...
def test_run_backtest_calls_backtester(tmp_path, monkeypatch):
    ...
    sample = [
        {'id': 'm1', 'date': '2025-01-01', 'league': league, 'home_team': 'A', 'away_team': 'B', 'home_goals': 1, 'away_goals': 0},
        {'id': 'm2', 'date': '2025-01-05', 'league': league, 'home_team': 'C', 'away_team': 'D', 'home_goals': 0, 'away_goals': 0},
    ]
    ...
    class StubBacktester:
        def run_backtest(self, predictor=None, model_name=None, test_matches=None, **kwargs):
            # Record what we got
