...
def test_get_min_interval_for_known_hosts():
    assert get_min_interval_for_host('https://api.football-data.org/v4/competitions/PL/matches') == 1.5
    assert get_min_interval_for_host('https://api-football-v1.p.rapidapi.com/v3/injuries') == 1.2
